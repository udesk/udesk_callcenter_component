...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AgentStatePanel = __webpack_require__(30);

	var _AgentStatePanel2 = _interopRequireDefault(_AgentStatePanel);

	var _Header = __webpack_require__(36);

	var _Header2 = _interopRequireDefault(_Header);

	var _HangupPanel = __webpack_require__(37);

	var _HangupPanel2 = _interopRequireDefault(_HangupPanel);

	var _RingingPanel = __webpack_require__(44);

	var _RingingPanel2 = _interopRequireDefault(_RingingPanel);

	var _TalkingPanel = __webpack_require__(49);

	var _TalkingPanel2 = _interopRequireDefault(_TalkingPanel);

	var _Const = __webpack_require__(31);

	var _Const2 = _interopRequireDefault(_Const);

	var _images = __webpack_require__(33);
	...
	var _CallQueue = __webpack_require__(104);

	var _CallQueue2 = _interopRequireDefault(_CallQueue);

	var _CallLog = __webpack_require__(105);

	var _CallLog2 = _interopRequireDefault(_CallLog);

	var _AjaxUtils = __webpack_require__(34);
	...
	var _CallInfo = __webpack_require__(46);
	...
	var _AgentSelect = __webpack_require__(51);
	...
	var UdeskCallcenterComponent = function UdeskCallcenterComponent(options) {
	    var token = options.token; //用于验证
	    _AjaxUtils2.default.token = token;
	    _AjaxUtils2.default.host = 'http://' + options.subDomain + '.udeskcat.com';
	    ...
	    var headerNode = new _Header2.default();
	    var agentStatePanel = this.agentStatePanel = new _AgentStatePanel2.default();
	    var hangupPanel = this.hangupPanel = new _HangupPanel2.default();
	    var talkingPanel = this.talkingPanel = new _TalkingPanel2.default();
	    var ringingPanel = this.ringingPanel = new _RingingPanel2.default();
	    ...
	    headerNode.toggleBtn.addEventListener('click', function () {
	        if (headerNode.open) {
	            ...
	            headerNode.toggleBtnImg.src = _images2.default.minimize;
	            agentStatePanel.setDropMenuDirection('up');
	        } else {
	            contentEle.style.display = 'block';
	            headerNode.open = true;
	            headerNode.toggleBtnImg.src = _images2.default.maximize;
	            agentStatePanel.setDropMenuDirection('down');
	        }
	    });

	    hangupPanel.onMakeCallFailure = function (error) {
	        _Alert2.default.error(error.message || '外呼失败');
	        self.switchHangupState();
	        _Tools2.default.isFunction(self.stopCallOutTimeout) && self.stopCallOutTimeout();
	    };
	    ...
	    _AjaxUtils2.default.get('/agent_api/v1/init_data', null, function (res) {
	    ...
	    var setTimeoutId;
	    _CallQueue2.default.on('change', function (calllog) {
	        clearTimeout(setTimeoutId);
	        self.switchLoading();

	        _CallInfo2.default.conversation_id = calllog.conversation_id;
	        _CallInfo2.default.agent_work_way = calllog.agent_work_way;
	        _CallInfo2.default.call_id = calllog.call_id;
	        _CallInfo2.default.can_consult = calllog.can_consult;
	        _CallInfo2.default.can_three_party = calllog.can_three_party;
	        _CallInfo2.default.can_transfer = calllog.can_transfer;
	        _CallInfo2.default.conversation_id = calllog.conversation_id;
	        _CallInfo2.default.direction = calllog.direction;
	        _CallInfo2.default.is_consult = calllog.is_consult;
	        _CallInfo2.default.state = calllog.state;

	        setTimeoutId = setTimeout(function () {
	            if (calllog.state === _Const2.default.RINGING) {
	                self.switchRingingState();
	            } else if (calllog.state === _Const2.default.TALKING) {
	                self.switchTalkingState();
	            } else if (calllog.state === _Const2.default.HANGUP) {
	                self.switchHangupState();
	            }
	        }, 3000);
	    });
	...
	UdeskCallcenterComponent.prototype.switchHangupState = function () {
	    ...
	    this.agentStatePanel.setCallState(_Const2.default.HANGUP);
	...
	UdeskCallcenterComponent.prototype.switchRingingState = function () {
	    ...
	    this.agentStatePanel.setCallState(_Const2.default.RINGING);
	    _AjaxUtils2.default.get("/agent_api/v1/desktop/conversation", { conversation_id: _CallInfo2.default.conversation_id }, function (res) {
	        _CallInfo2.default.set('call_type', res.call_type);
	        _CallInfo2.default.set('queue_desc', res.queue_desc);

	        console.log('conversation', res);
	    });
	    _Tools2.default.isFunction(this.stopCallOutTimeout) && this.stopCallOutTimeout();
	};
	...
	UdeskCallcenterComponent.prototype.switchTalkingState = function () {
	    ...
	    this.agentStatePanel.setCallState(_Const2.default.TALKING);
	    _Tools2.default.isFunction(this.stopCallOutTimeout) && this.stopCallOutTimeout();
	};
	...
	UdeskCallcenterComponent.prototype.connectWebSocket = function () {
	    var self = this;
	    this.socket = new _socket2.default(this.tower_url, this.user_id, this.seatToken);

	    //websocket
	    this.socket.onNotice(function (msg) {
	        switch (msg.type) {
	            case 'call_log':
	                _CallQueue2.default.put(new _CallLog2.default(msg));
	                break;
	            case 'seat_status':
	    ...
	    this.socket.onException(function (msg) {
	        switch (msg.error) {
	            case 'connected_at_other_place':
	                _Alert2.default.error(msg.message);
	        }
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#udesk-callcenter-component-alert{position:fixed;top:100px;left:50%;transform:translateX(-50%);padding:20px 30px;color:#fff}.udesk-callcenter-component{background-color:#fff;width:270px;position:fixed;right:0;bottom:0}.udesk-callcenter-component .content-wrapper{display:none;padding:20px;border:1px solid #e4e4e4;border-top-width:0;color:#666;font-size:14px}.udesk-callcenter-component .ucm-dropdown ul{border:1px solid #ccc;padding:3px;position:absolute;left:0;top:100%;margin:0;display:none;width:100%;background-color:#fff;z-index:9999999;list-style:none}.udesk-callcenter-component .ucm-dropdown ul li{padding:3px 0;cursor:pointer}.udesk-callcenter-component .ucm-dropdown ul li:hover{background-color:#c3c3c3}.udesk-callcenter-component .work-state-busy i,.udesk-callcenter-component .work-state-idle i,.udesk-callcenter-component .work-state-offline i,.udesk-callcenter-component .work-state-resting i,.udesk-callcenter-component .work-state-ringing i,.udesk-callcenter-component .work-state-talking i{display:inline-block;vertical-align:middle;width:10px;height:10px;margin-right:3px;-webkit-border-radius:10px;-moz-border-radius:10px;border-radius:10px}.udesk-callcenter-component .work-state-idle i{background-color:#49b34f}.udesk-callcenter-component .work-state-busy i,.udesk-callcenter-component .work-state-offline i,.udesk-callcenter-component .work-state-resting i,.udesk-callcenter-component .work-state-ringing i,.udesk-callcenter-component .work-state-talking i{background-color:#d75452}.udesk-callcenter-component .agent-select{position:relative}.udesk-callcenter-component .agent-select .dropdown{height:240px;overflow:auto;position:absolute;left:0;right:0;bottom:100%;border:1px solid #c3c3c3;background-color:#fff;margin:0;padding:0}.udesk-callcenter-component .agent-select .dropdown li{list-style-type:none;text-align:left;padding:5px;cursor:pointer}.udesk-callcenter-component .agent-select .dropdown li:hover{background-color:#e0e0e0}.udesk-callcenter-component .agent-select .display-frame{border:1px solid #c3c3c3;padding:5px;font-size:12px;text-align:left;height:12px;cursor:pointer}.udesk-callcenter-component .agent-select .display-frame img{float:right;margin-top:3px}", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "dist/674f50d287a8c48dc19ba404d20fe713.eot";
...
/***/ function(module, exports) {
	...
	module.exports = "dist/af7ae505a9eed503f8b8e6982036873e.woff2";

/***/ },
/* 25 */
/***/ function(module, exports) {

	module.exports = "dist/fee66e712a8a08eef5805a46892932ad.woff";

/***/ },
/* 26 */
/***/ function(module, exports) {

	module.exports = "dist/b06871f281fee6b241d60582ae9369b9.ttf";

/***/ },
/* 27 */
/***/ function(module, exports) {

	module.exports = "dist/912ec66d7572ff821749319396470bde.svg";
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    for (var i in patches) {
	        i in document.documentElement || Object.defineProperty(Element.prototype, i, { get: patches[i] });
	    }
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DropdownBtn = __webpack_require__(32);
	var AjaxUtils = __webpack_require__(34);
	var Alert = __webpack_require__(35);
	...
	var AgentStatePanel = function AgentStatePanel() {
	    var wayDropdownBtn = this.wayDropdownBtn = new DropdownBtn({
	        content: [{ id: Const.FIXED_VOIP_ONLINE, name: 'IP话机' }, { id: Const.PHONE_ONLINE, name: '手机' }]
	    });
	    ...
	    var stateDropdownBtn = this.stateDropdownBtn = new DropdownBtn({
	        content: [{ id: Const.IDLE, name: stateDropdownItem('idle') }, { id: Const.BUSY, name: stateDropdownItem('busy') }, { id: Const.RESTING, name: stateDropdownItem('resting') }, { id: Const.OFFLINE, name: stateDropdownItem('offline') }]
	    });
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    OPEN_YTXAPP: 'open_ytxapp',
	    OPEN_UCPAPP: 'open_ucpapp',

	    FIXED_VOIP_ONLINE: 'fixed_voip_online',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doc = document;
	var DropdownBtn = function DropdownBtn(opt) {
	    ...
	    this.content = content || [{ id: '0', name: '' }];
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    minimize: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAYAAABWdVznAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAjSURBVChTY/wPBAykAFI0gNQyQdlEg1ENxADaayAxaTAwAAD0+BAFgslReAAAAABJRU5ErkJggg==',
	    maximize: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAABCAYAAADXeS5fAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAQSURBVBhXY/wPBAxkAwYGAPmIA/59nbjdAAAAAElFTkSuQmCC'
	};
...
/***/ function(module, exports) {
	...
	var doc = document;
	var timeoutId;
	var Alert = function Alert(text, type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//挂断状态的界面
	var NumberInput = __webpack_require__(39);
	var Keyboard = __webpack_require__(40);
	var CallBtn = __webpack_require__(42);
	var eventTool = __webpack_require__(43);
	...
	module.exports = function () {
	    ...
	    this.callBtn.element.onclick = function (e) {
	        _Tools2.default.isFunction(self.onBeforeCalling) && self.onBeforeCalling();
	...
	function makeCall(callNumber, successCallback, failureCallback) {
	    ...
	    if (/^[\d*#+]{4,}$/.test(callNumber)) {
	        _Tools2.default.isFunction(successCallback) && successCallback();
	    } else {
	        _Tools2.default.isFunction(failureCallback) && failureCallback(new Error('电话号码格式不正确'));
	        return;
	    }

	    _AjaxUtils2.default.post('/agent_api/v1/desktop/make_call', { number: callNumber }, function (res) {
	        switch (res.code) {
	            case 1000:
	                _Alert2.default.success('已发起外呼请求');
	                break;
	            default:
	                _Alert2.default.error(res.message || '外呼失败');
	        }
	    }, function () {
	        _Alert2.default.error('外呼失败');
	    });
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    humanizeTime: function humanizeTime(seconds) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyBtn = __webpack_require__(41);

	var doc = document;
	var Keyboard = function Keyboard(numberInput) {
	    this.element = doc.createElement('div');
	    this.element.style.display = 'none';
...
/***/ function(module, exports) {
	...
	var doc = document;
	var KeyBtn = function KeyBtn(number, numberInput) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doc = document;
	var CallBtn = function CallBtn(type) {
	    this.element = doc.createElement('button');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserHeadImage = __webpack_require__(45);

	var _UserHeadImage2 = _interopRequireDefault(_UserHeadImage);

	var _CallInfo = __webpack_require__(46);

	var _CallInfo2 = _interopRequireDefault(_CallInfo);

	var _HorizontalRule = __webpack_require__(48);
	...
	var _CallButton = __webpack_require__(42);

	var _CallButton2 = _interopRequireDefault(_CallButton);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var doc = document;
	var RingingPanel = function RingingPanel() {
	    var contentEle = doc.createElement('div');
	    var hr = new _HorizontalRule2.default().element;
	    var numberInfo = doc.createElement('div');

	    this.userHeadImage = new _UserHeadImage2.default();

	    contentEle.appendChild(this.userHeadImage.element);
	    contentEle.style.textAlign = 'center';
	    numberInfo.style.padding = '5px 0';
	    numberInfo.innerHTML = _CallInfo2.default.customer_phone + '&nbsp;&nbsp;' + _CallInfo2.default.phone_location;
	    ...
	    _CallInfo2.default.ringingTime = 0;
	    timeEle.innerText = _Tools2.default.humanizeTime(_CallInfo2.default.ringingTime);
	    ...
	    var self = this;
	    _CallInfo2.default.on('change', function () {
	        self.setQueueDesc(_CallInfo2.default.queue_desc);
	    });
	};
	...
	RingingPanel.prototype.startTiming = function () {
	    ...
	    this.intervalId = setInterval(function () {
	        _CallInfo2.default.ringingTime += 1;
	        self.timeEle.innerText = _Tools2.default.humanizeTime(_CallInfo2.default.ringingTime);
	    }, 1000);
	};
	    ...
	    _createClass(Eventable, [{
	        ...
	        value: function fire() {
	            ...
	            for (var i = 0, len = events.length; i < len; i++) {
	                _Tools2.default.isFunction(events[i]) && events[i].apply(this, [].splice.call(arguments, 1));
	            }
	        }
	    }, {
	        key: 'on',
...
/***/ function(module, exports) {
	...
	module.exports = function () {
	    ...
	    this.element.style.marginBottom = '18px';
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonWithImage = __webpack_require__(50);

	var _ButtonWithImage2 = _interopRequireDefault(_ButtonWithImage);
	...
	var doc = document;
	var TalkingPanel = function TalkingPanel(options) {
	    this.agentSelectType = '';
	    this.userHeadImg = new _UserHeadImage2.default();
	    //var muteBtn = new ButtonWithImage(images.mute, '静音');
	    var transferBtn = new _ButtonWithImage2.default(_images2.default.transfer, '转移');
	    var consultBtn = new _ButtonWithImage2.default(_images2.default.consult, '咨询');
	    var threeWayCallingBtn = new _ButtonWithImage2.default(_images2.default.threeWayCalling, '三方');
	    var hr = new _HorizontalRule2.default();
	    var agentSelect = this.agentSelect = new _AgentSelect2.default();
	    ...
	    _CallInfo2.default.on('change', function () {
	        if (_CallInfo2.default.call_type !== '呼入') {
	        ...
	        if (_CallInfo2.default.queue_desc) {
	            descInfo.innerHTML = '来源：' + _CallInfo2.default.queue_desc;
	        } else {
	            descInfo.innerHTML = '';
	        }
	    });
	...
	TalkingPanel.prototype.clearAndStopTiming = function () {
	    this.stopTiming();
	    _CallInfo2.default.talkingTime = 0;
	};

	TalkingPanel.prototype.startTiming = function () {
	    var self = this;
	    this.intervalId = setInterval(function () {
	        _CallInfo2.default.talkingTime += 1;
	        self.timeEle.innerText = _Tools2.default.humanizeTime(_CallInfo2.default.talkingTime);
	    }, 1000);
	};
	...
	TalkingPanel.prototype.transfer = function (agent) {
	    _AjaxUtils2.default.post('/agent_api/v1/desktop/transfer_call', { agent_no: agent.id }, function (res) {
	        switch (res.code) {
	            case 1001:
	                _Alert2.default.success('转移的请求已经发送！');
	                break;
	            default:
	                _Alert2.default.error(res.message || '转移失败！');
	        }
	    }, function () {
	        _Alert2.default.error('转移失败');
	    });
	};

	TalkingPanel.prototype.consult = function (agent) {
	    _AjaxUtils2.default.post('/agent_api/v1/desktop/start_consult', { agent_no: agent.id }, function (res) {
	        switch (res.code) {
	            case 1001:
	                _Alert2.default.success('咨询的请求已经发送！');
	                break;
	            default:
	                _Alert2.default.error(res.message || '咨询失败');
	        }
	    }, function () {
	        _Alert2.default.error('咨询失败');
	    });
	};

	TalkingPanel.prototype.threeWayCalling = function (agent) {
	    _AjaxUtils2.default.post('/agent_api/v1/desktop/three_party', { agent_no: agent.id }, function (res) {
	        switch (res.code) {
	            case 1001:
	                _Alert2.default.success('三方的请求已经发送！');
	                break;
	            default:
	                _Alert2.default.error(res.message || '三方失败！');
	        }
	    }, function () {
	        _Alert2.default.error('三方失败');
	    });
	};
...
/***/ function(module, exports) {
	...
	var doc = document;
	var ImageTextButton = function ImageTextButton(imageURL, text) {
	    this.text = text;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doc = document;
	var AgentSelect = function AgentSelect() {
	    this.maxPage = 1;
	    this.page = 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fun = function fun(url, userId, seatToken) {
	    this.callbackList = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(56)('socket.io-client');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(56)('socket.io-client:url');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(56)('socket.io-client:manager');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseqs = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(81);
	var inherit = __webpack_require__(91);
	var yeast = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasBinary = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(101);
	var bind = __webpack_require__(102);
	var debug = __webpack_require__(56)('socket.io-client:socket');
...
/***/ function(module, exports, __webpack_require__) {
	...
	//["notice",{"type":"call_log","state":"ringing","call_id":"161205154856651300010177000a1772","conversation_id":"3274167","agent_work_way":"phone_online","direction":"in","can_transfer":"true"}]
	var Const = __webpack_require__(31);
	var CallLog = __webpack_require__(105);

	var CallQueue = function CallQueue() {
	    this.queue = [];
	    this.eventMap = {
	        change: []
	    };
...
/***/ function(module, exports) {
	...
	var CallLog = function CallLog(opt) {
